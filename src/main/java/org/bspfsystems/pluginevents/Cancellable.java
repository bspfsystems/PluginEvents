...
/**
 * Implemented by some {@link Event Events} if they can be cancelled, preventing
 * further {@link EventHandler EventHandlers} from processing the {@link Event}.
 * <p>
...
public interface Cancellable {
     ...
     * 
     * @return {@code true} if the {@link Event} has been cancelled,
     ...
     * <p>
     * Only {@link EventHandler EventHandlers} that have {@code ignoreCancelled}
     * set to {@code true} will not process the {@link Event}. All others will
     * process as if the {@link Event} was not cancelled.
     * 
     * @param cancelled {@code true} if the {@link Event} is to be cancelled,
     *                  {@code false} otherwise.
     */
